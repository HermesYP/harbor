  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      {selectMode ? (
        ...
        <div className="flex flex-wrap items-center gap-2.5 rounded-xl bg-amber-500/12 px-3.5 py-2.5 ring-1 ring-amber-500/30">
          ...
          <button
            ...
            onClick={() =>
              updateLocalEntries(
                items.filter((e) => e.needsReview).map((e) => e.id),
                { needsReview: false },
              )
            }
            title={t("Dismiss all current reviews. You can still use Fix match on any title.")}
            className="rounded-full px-3 py-1 text-[11.5px] font-semibold text-ink-muted transition-colors hover:bg-amber-500/20 hover:text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber-500"
          >
            {t("Ignore")}
          </button>
          <button
            ...
            className="rounded-full bg-amber-500 px-3 py-1 text-[11.5px] font-semibold text-black transition-colors hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber-500"
          >
            {t("Review")}
          </button>
        </div>
